...
// una consulta personalizada
    @Query( nativeQuery = true  ,  value= "SELECT * FROM Docentes e WHERE e.correo like %:term% ") // Consulta a nivel de base datos
    public List<Docente> findByCorreo(@Param("term") String term);
}
